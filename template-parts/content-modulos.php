	...
	<div class="container p-t-50 p-b-50 text-center m-t-145">
		<div class="bg-modulos">
			...
			<ul class="inline-list">
				<li><a href="<?php echo esc_url( home_url( '/' ) ); ?>lira"><img src="<?php echo get_template_directory_uri(); ?>/assets/imagens/home/lira.png" alt="lira"></a></li>
				<li><a href="<?php echo esc_url( home_url( '/' ) ); ?>auditoria"><img src="<?php echo get_template_directory_uri(); ?>/assets/imagens/home/auditoria.png" alt="auditoria"></a></li>
