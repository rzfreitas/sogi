			...
			<div class="row d-flex">
				...
				<div class="col-12 col-md-8">
					<ul class="mod-list d-flex flex-wrap">
						...
						<li><a href="<?php echo esc_url( home_url( '/' ) ); ?>gaia"><img src="<?php echo get_template_directory_uri(); ?>/assets/imagens/modulos/gaia-icon.png" alt="gaia" title="Módulo Gaia"></a></li>
						<li><a href="<?php echo esc_url( home_url( '/' ) ); ?>prsso"><img src="<?php echo get_template_directory_uri(); ?>/assets/imagens/modulos/prsso-icon.png" alt="prsso" title="Módulo PRSSO"></a></li>
