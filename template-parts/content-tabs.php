				...
				<div class="col-3">
					<nav>
					  <div class="nav nav-tabs" id="nav-tab" role="tablist">
					    ...
					    <a class="nav-item nav-link" id="nav-rn-tab" data-toggle="tab" href="#nav-rn" role="tab" aria-controls="nav-rn" aria-selected="false">Risco de Negócios</a>
					    ...
					    <a class="nav-item nav-link" id="nav-adm-tab" data-toggle="tab" href="#nav-adm" role="tab" aria-controls="nav-adm" aria-selected="false">Administrativo</a>
					  </div>
					</nav>
				</div>
